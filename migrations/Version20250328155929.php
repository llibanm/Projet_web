 ...
 */
final class Version20250328155929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, libelle, prix, quantite_en_stock, enstock FROM produit');
        $this->addSql('DROP TABLE produit');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(100) DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, quantite_en_stock INTEGER DEFAULT NULL, enstock BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO produit (id, libelle, prix, quantite_en_stock, enstock) SELECT id, libelle, prix, quantite_en_stock, enstock FROM __temp__produit');
