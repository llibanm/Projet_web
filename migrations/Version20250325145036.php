 ...
 */
final class Version20250325145036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO produit (id, libelle, prix, quantite) SELECT id, libelle, prix, quantite FROM __temp__produit');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, libelle, prix, quantite FROM produit');
        $this->addSql('DROP TABLE produit');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(100) NOT NULL, prix INTEGER NOT NULL, quantite INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO produit (id, libelle, prix, quantite) SELECT id, libelle, prix, quantite FROM __temp__produit');
        $this->addSql('DROP TABLE __temp__produit');
    }
}
