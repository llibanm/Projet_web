 ...
 */
final class Version20250325131406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN nom VARCHAR(30) NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN prenom VARCHAR(30) NOT NULL');
